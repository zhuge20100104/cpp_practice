...
#ifndef Sample_Employee_INCLUDED
#define Sample_Employee_INCLUDED
...
template <>
class TypeHandler<Sample::Employee>
{
public:
	...
	static void bind(std::size_t pos, const Sample::Employee& ar, AbstractBinder::Ptr pBinder, AbstractBinder::Direction dir)
	{
	...
	static void extract(std::size_t pos, Sample::Employee& ar, const Sample::Employee& deflt, AbstractExtractor::Ptr pExtr)
	{
	...
	static void prepare(std::size_t pos, const Sample::Employee& ar, AbstractPreparator::Ptr pPrep)
	{
...
#endif // Sample_Employee_INCLUDED
